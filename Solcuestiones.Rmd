...
#En texto hay 268 espacios en blanco.

a<-str_count(pattern=' ',string =texto)
a

#En texto hay 936 caracteres que no son vocales (sin acentuar). Se incluye la y.
b<-str_count(pattern='[^aeiou]',string =texto)
b

#En texto hay 600 consonantes

c<-str_count(pattern='[bcdfghjklmnpqrstvwxyz]', string=texto )
c
#En texto hay 502 vocales (sin acentuar).

c<-str_count(patter='[aeiou]',string =texto )
c

#En texto hay 503 vocales (sin acentuar).

d<-str_count(patter='[aeiou]',string =texto )
d
